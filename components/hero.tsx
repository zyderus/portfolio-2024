...
export default function Hero({ lang, dictionary }: SectionProps) {
  return (
    <section id='home' className='min-h-screen py-24 xs:text-left'>
      <div className='flex flex-col space-y-8 max-w-[800px] mx-auto mt-[10vh]'>
        ...
        <LinkIntl
          href='/contact'
          lang={lang}
          className='w-max mx-auto xs:mx-[initial]'
        >
          <button className='relative flex justify-center items-center bg-accent hover:bg-bg-secondary text-md sm:text-xl px-3 xs:px-6 sm:px-12 py-2 xs:py-3 sm:py-5 rounded-lg sm:rounded-xl transition duration-100'>
            Message me
          </button>
        </LinkIntl>
        <div className='flex space-x-4 mt-4 mx-auto xs:mx-[initial]'>
          <a
